...
# --------------TEST ACCESS TO LESSION 10 PART 1(JAPAN) --------------
    ...
    #     quantity_video = 13
    #     description = "TEST DONE SYSTEM IN VIENAMESE WITH EXERCISE FIRST "
    ...
    def test_vie_class_second(self):
        app_language = '//android.view.View/android.view.ViewGroup[2]'
        ex_class_scroll_num = 0
        ex_class = '//android.widget.TextView[@text="Bài 5 (Miễn Phí): Yoga giảm đau thần kinh toạ hiệu quả"]'
        ex_video_scroll_num = -1
        ex_video = '//android.widget.TextView[@text="1. Khởi động"]'
        ex_video_agree ='//android.widget.TextView[@text="Tập luyện thường"]'
        quantity_video = 13
        description = "TEST DONE SYSTEM IN VIENAMESE WITH EXERCISE SECOND"
        self.common_step(app_language,ex_class_scroll_num, ex_class, ex_video_scroll_num, ex_video, ex_video_agree, quantity_video, description)            
    ...
    #     description = "TEST DONE SYSTEM IN ENGLISH"
    #     self.common_step(app_language,ex_class_scroll_num, ex_class, ex_video_scroll_num, ex_video, ex_video_agree, quantity_video, description)
    ...
    #     description = "TEST DONE SYSTEM IN JAPAN"
    #     self.common_step(app_language,ex_class_scroll_num, ex_class, ex_video_scroll_num, ex_video, ex_video_agree, description)
